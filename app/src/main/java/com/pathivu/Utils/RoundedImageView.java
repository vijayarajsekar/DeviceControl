...
/**
 * Created by VijayarajSekar on 21/7/15.
 */
...
public class RoundedImageView extends ImageView {
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attributes.getBoolean(R.styleable.RoundedImageView_border, true)) {
            ...
            setBorderWidth(attributes.getDimensionPixelOffset(R.styleable.RoundedImageView_border_width, defaultBorderSize));
            setBorderColor(attributes.getColor(R.styleable.RoundedImageView_border_color, Color.WHITE));
        }
